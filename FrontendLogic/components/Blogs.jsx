...
//   console.log('Fetcher function called with args:', args);
//   try {
...
//     console.log(allBlogs, 'lalaalall');
//     const reversedBlog = allBlogs.slice().reverse();
//     // dispatchR(addBlogs(reversedBlog));
//     return data;
//   } catch (error) {
...
// const {a , e } = useSWR('https://dummyjson.com/products', datala)
